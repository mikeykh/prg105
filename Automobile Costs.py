...
def main():
    # This function is used to gather all of the information and calls the function calculate_total_monthly_cost.
    ...
    calculate_total_monthly_cost(loan, insurance, gas, oil, tire, maintenance)


def calculate_total_monthly_cost(loan, insurance, gas, oil, tire, maintenance):
    # This function calculates and prints the total monthly cost and calls the function calculate_total_yearly_cost.
...
def calculate_total_yearly_cost(total_monthly_cost):
    ...
    print("This is the annual cost: $", format(yearly_total, ',.2f'), sep="")
